...
const ProjectCard = ({ project }: { project: ProjectProps }) => {
  return (
    <Card className="overflow-hidden bg-card border-teal-900/50 hover:border-teal-500 transition-all duration-300 h-full group">
          ...
          <div className="w-full">
            <div className="flex flex-wrap gap-2 mb-2">
              {project.technologies.slice(0, 3).map((tech) => (
                <span
                  key={tech}
                  className="py-1 px-2 bg-teal-500/20 text-teal-400 text-xs rounded-full"
                >
                  {tech}
                </span>
              ))}
              {project.technologies.length > 3 && (
                <span className="py-1 px-2 bg-gray-700/50 text-gray-300 text-xs rounded-full">
        ...
        <div className="flex gap-3">
          {project.githubUrl && (
            <a
              ...
              className="inline-flex items-center text-sm text-gray-300 hover:text-teal-400 transition-colors"
            >
