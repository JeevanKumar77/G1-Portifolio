        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          >
            <motion.div variants={fadeIn} className="mb-4">
              <span className="inline-block py-1 px-4 text-sm font-medium bg-teal-500/20 text-teal-400 rounded-full mb-4 backdrop-blur-sm border border-teal-500/20">
            ...
            >
              Hello, I'm{" "}
              <span className="text-gradient bg-gradient-to-r from-teal-400 via-teal-300 to-teal-500 bg-clip-text text-transparent">Ch. Jeevan Kumar</span>
            </motion.h1>
            ...
            >
              ...
              <div className="flex space-x-2">
                <a
                  ...
                  className="p-2 rounded-full bg-card hover:bg-teal-500/20 transition-colors"
                >
                  <Github size={18} />
                </a>
                <a
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-2xl bg-gradient-to-br from-teal-500/20 to-teal-700/20 backdrop-blur-sm border border-teal-500/20 flex items-center justify-center p-2">
                ...
                {/* Floating badges */}
                <div className="absolute -top-4 -right-4 py-2 px-4 bg-card rounded-full text-sm border border-teal-700 shadow-lg animate-bounce-slow">
                  Python
                </div>
                <div className="absolute -bottom-4 -left-4 py-2 px-4 bg-card rounded-full text-sm border border-teal-700 shadow-lg animate-pulse-slow">
                  React
                </div>
              </div>
