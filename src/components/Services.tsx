...
const ServiceCard = ({ icon, title, description }: ServiceProps) => {
  return (
    <Card className="bg-card border border-teal-900/50 hover:border-teal-500 transition-all duration-300 h-full group">
  ...
  return (
    <section id="services" className="py-20 relative">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute bottom-40 left-20 w-80 h-80 bg-teal-500/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mt-6">
            I provide end-to-end web development services, creating dynamic, responsive websites
